...
example_datasets <- 
 tribble(
    ...
    "C:/Users/Ian/Data/r-projects/temp/data/Employee-earnings-and-hours.xlsx","Table_1")
```
...
tidy_ABS_sheet(path = example_datasets$file_location[[1]],sheets = example_datasets$sheet[[1]])
  



abs_sheet_processed <- process_abs_sheet(path = example_datasets$file_location[[1]],
                                         example_datasets$sheet[[1]])
...
abs_sheet_processed <- process_abs_sheet(path = example_datasets$file_location[[2]],
                                         example_datasets$sheet[[2]])
...
abs_sheet_processed <- process_ABS_sheet(path = example_datasets$file_location[[3]],
                                         ...
                                         manual_value_references =  c(2,15,11,34))
...
abs_sheet_processed <- process_ABS_sheet(path = example_datasets$file_location[[4]],
                                         example_datasets$sheet[[4]],manual_value_references =  c(2,8,8,234))
...
abs_sheet_processed <- process_ABS_sheet(path = example_datasets$file_location[[5]],
                                         example_datasets$sheet[[5]])
