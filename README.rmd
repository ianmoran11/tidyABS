...
We can also visualize how these groups are spatially layed out in the spreadsheet any how tidyABS will relate them to table values with the function `plot_table_components`. Row names directly to the left of their data points should be labelled "W", and column names directly above should be labelled "N". (See the [unpivotr](https://github.com/nacnudus/unpivotr) package for more information.)
